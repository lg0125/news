...
public class ApReadBehaviorServiceImpl implements ApReadBehaviorService {
    ...
    public ResponseResult readBehavior(ReadBehaviorDto dto) {
        ...
        cacheService.hPut(
                "READ-BEHAVIOR-" + dto.getArticleId().toString(),
                user.getId().toString(),
        ...
        mess.setType(UpdateArticleMessage.UpdateArticleType.VIEWS);
        mess.setAdd(1);
